...
const ChapterEditorTab = ({
    ...
    const formatMarkdown = (content) => {
        ...
        .replace(/^> (.*$)/gm, '<blockquote class="border-l-4 border-violet-500 pl-4 italic my-4 text-gray-700">$1</blockquote>')
...
.join('');
        ...
        return (
            <div className="flex-1 flex items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="text-lg text-gray-500">Select a chapter to start editing</p>
    ...
    return <div className={`${isFullSceen ? 'fixed inset-0 z-50 bg-white' : 'flex-1'} flex flex-col`}>
